...
* Western Digital
  * [Gold Enterprise Class SATA HDD](https://documents.westerndigital.com/content/dam/doc-library/en_us/assets/public/western-digital/product/internal-drives/wd-gold/product-brief-wd-gold-2579-810192.pdf) (Ships with SATA + 4Kn/512e only)
  * Ultrastar DC HC (Ships with choice of SATA or SAS and native sector size. Both the 300 and 500 series HDDs have the same workload rating, but the 500 series is helium filled and has a low annualized failure rate (AFR). The 2nd digit in the series number is apparently a drive raw capacity reference)
